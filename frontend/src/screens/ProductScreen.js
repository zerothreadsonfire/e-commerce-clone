...
import { Row, Col, Button, Image, ListGroup, Card, Form, Nav } from 'react-bootstrap';
        ...
        <Col md={3}>
          <Card>
            <ListGroup variant="flush">
              ...
              <ListGroup.Item>
                <Button type="button" className="btn btn-block" disabled={product.countInStock === 0} onClick={addToCartHandler}>Add To Cart</Button>
              </ListGroup.Item>
            </ListGroup>
          </Card>
        </Col>
